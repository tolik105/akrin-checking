...
export const caseStudiesEN: CaseStudyItem[] = [
  ...
  },
  {
    ...
    titleEN: 'Cloud Migration (Kantō / Osaka)',
    titleJA: 'クラウド移行（関東・大阪）',
  ...
  },
  {
    ...
    titleEN: 'Application Penetration Testing (Tokyo)',
    titleJA: 'アプリ脆弱性診断（東京）',
  ...
  },
  {
    ...
    titleEN: 'Wi‑Fi Assessment & Optimization (Tokyo + Warehouse)',
    titleJA: 'Wi‑Fiアセスメント・最適化（東京＋倉庫）',
  ...
  },
  {
    ...
    titleEN: 'SD‑WAN Deployment (Nationwide, 30+ Sites)',
    titleJA: 'SD‑WAN導入（全国30拠点超）',
